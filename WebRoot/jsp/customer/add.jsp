        ...
        <tbody>
            ...
            <tr class="formtitletr">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" name="customer.khbh"/>
                </td>
                <td class="formtitle" align="right">
                    简称(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" name="customer.jc"/>
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle" align="right">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" name="customer.lxdh"/>
                </td>
            </tr>
            <tr class="formtitle" align="right">
                ...
                <td class="formcontent" colspan="3">
                    <input type="text" class="input1" name="customer.dz"/>
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle" align="right">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" name="customer.qy"/>
                </td>
                <td class="formtitle" align="right">
                    业务员(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" name="customer.ywy"/>
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle" align="right">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" name="customer.fhfs"/>
                </td>
                <td class="formtitle" align="right">
                    回款方式(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" name="customer.hkfs"/>
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle" align="right">
                ...
                <td class="formcontent" colspan="3">
                    <textarea style="width:100%" rows="8" name="customer.bz"></textarea>
                </td>
            </tr>
            <tr>

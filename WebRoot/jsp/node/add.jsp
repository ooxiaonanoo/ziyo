...
<div class="main-data">
	<!-- 用户类型，暂时默认0 -->
 	<input type="hidden"  value="0"  name="node.userType"/>
    <table width="100%" cellspacing="0" cellpadding="2" bordercolor="#9fd9e8" border="1" bgcolor="#d0e6f1" bordercolordark="#EDF2FA">
        <tbody>
            ...
            <tr class="formtitle">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" name="node.userAccount"/>
                </td>
                <td class="formtitle" align="right">
                    用户密码(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" name="node.userPwd"/>
                </td>
            </tr>
            <tr class="formtitletr">
            	 <td class="formtitle" align="right">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" name="node.userName"/>
                </td>
                <td class="formtitle" align="right">
                    联系电话(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" name="node.userPhone"/>
                </td>
            </tr>
            <tr class="formtitle">
            	<td class="formtitle" align="right">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" name="node.userEmail"/>
                </td>
                <td class="formtitle" align="right">
            ...
            <tr class="formtitle">
                ...
                <td class="formcontent" colspan="3">
                    <textarea style="width:100%" rows="8" name="node.userRem"></textarea>
                </td>
            </tr>
            <tr>

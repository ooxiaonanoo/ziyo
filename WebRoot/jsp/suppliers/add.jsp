    ...
    <table width="100%" cellspacing="0" cellpadding="2" bordercolor="#9fd9e8" border="1" bgcolor="#d0e6f1" bordercolordark="#EDF2FA">
        <tbody>
            ...
            <tr class="formtitle">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" id="writeName" value="" name="suppliers.lxr"/>
                </td>
                <td class="formtitle">
                    联系电话(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" id="phone"  name="suppliers.lxdh"/>
                </td>
            </tr>
             <tr class="formtitle">
                <td class="formtitle">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" id="writeName" name="suppliers.dz"/>
                </td>
                <td class="formtitle">
                    属性(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" id="phone"  name="suppliers.sx"/>
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle">
                ...
                <td class="formcontent" colspan="3">
                    <textarea  cols="40" rows="8" id="tpaService" name="suppliers.bz"></textarea>
                </td>
            </tr>
            <tr>

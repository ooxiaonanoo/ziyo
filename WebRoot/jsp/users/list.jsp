...
<body>
  <div class="list">
 	<strong>用户查询</strong>
 		<form action="/ziYo/usersAction/findBySql"  method="post" >
 			<table width="100%" border="1" bordercolor="#9FD9E8" cellpadding="2" cellspacing="0" bordercolordark="#EDF2FA" bgcolor="#D0E6F1">
 				<tr>
                    ...
                    <td width="60" bgcolor="#F4F2F2">
                        <input type="text" id="" value="${users.userName}" name="customer.khmc"/>
                    </td>
                    <td width="80" align="right" bgcolor="#D0E6F1">
                        <strong>邮箱：</strong>
                    </td>
                    <td width="60" bgcolor="#F4F2F2">
                        <input type="text"  id="" value="${users.userEmail}" name="customer.dz"/>
                    </td>
                    <td width="80" align="right" bgcolor="#D0E6F1">
                        <strong>电话：</strong>
                    </td>
                    <td width="80" bgcolor="#F4F2F2">
                        <input type="text" id="" value="${users.userPhone}" name="customer.ywy"/>
                    </td>
                    <td bgcolor="#F4F2F2">
                        ...
                        <table width="100%" border="1" bordercolor="#9FD9E8"
                            ...
                            <c:forEach var="ass" items="${listAss}" >
                                <tr bgcolor="#E7F2F8" onMouseOver="this.bgColor='#FFFFFF';" onMouseOut="this.bgColor='#E7F2F8';">
                                    ...
                                    <td align="center">
                                        <a href="/ziYo/usersAction/getById?id=${ass.id}&returnType=update">修改</a>
                                    </td>
                                </tr>
                            </c:forEach >
                        </table>
